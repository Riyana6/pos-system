        ...
        <div className="fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal} title="Create Order">
                ...
                <div>
                    <label className="block text-[#ababab] mb-2 text-sm font-medium">Customer Name</label>
                    <div className="flex items-center rounded-lg p-3 px-4 bg-[#1f1f1f]">
                        <input value={phone} onChange={(e) => setPhone(e.target.value)} type="number" name="" placeholder="+94-999999999" id=""
                            className="bg-transparent flex-1 text-white focus:outline-none" />
                    </div>
                </div>
                <div>
                    ...
                    <div className="flex items-center justify-between bg-[#1f1f1f] px-4 py-3 rounded-lg">
                        <button onClick={decrementGuestCount} className="text-yellow-500 text-2x1">&minus;</button>
                        <span className="text-white">{guestCount} Person</span>
                        <button onClick={incrementGuestCount} className="text-yellow-500 text-2xl">&#43;</button>
                    </div>
                </div>
